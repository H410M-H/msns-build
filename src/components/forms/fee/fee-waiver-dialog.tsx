    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Apply a discount or scholarship to reduce the fee amount.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6 py-4">
              ...
              {discountPresets.map((preset) => (
                <Button
                  ...
                  className={cn(
                    "transition-all",
                    waiverType === "percent" &&
                      Number(waiverValue) === preset.value
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Select
                value={waiverType}
                onValueChange={(v) => setWaiverType(v as "percent" | "fixed")}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div>
              ...
              <Input
                ...
                placeholder={
                  waiverType === "percent" ? "e.g., 25" : "e.g., 1000"
                }
          ...
          {discount > 0 && (
            <div className="rounded-lg border border-purple-200 bg-purple-50 p-4">
              ...
              <p className="mt-2 text-xs text-purple-600">
                Final Fee: Rs.{" "}
                {Math.max(baseFee - discount, 0).toLocaleString()}
              </p>
            </div>
          )}
        </div>
