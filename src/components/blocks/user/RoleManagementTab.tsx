...
const SYSTEM_ROLES: RoleDef[] = [
  ...
  },
  {
    role: "PRINCIPAL",
    label: "Principal",
    description: "Academic leadership, institutional performance monitoring, ERP, and staff oversight.",
  ...
  },
  {
    ...
    description: "Section supervision, academic routines, examinations, ERP & financials, and attendance compliance.",
  ...
  },
  {
    ...
    description: "Student enrollments, fee challans, examination marking, ERP & financials, and record keeping.",
