  ...
  return (
    <section className="mb-12">
      ...
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center gap-4">
        <div className="flex items-center gap-4">
          <div className="relative">
            <div className="rotate-1 transform rounded-2xl bg-linear-to-br from-purple-500 to-pink-600 p-3 shadow-lg shadow-purple-500/20 dark:shadow-purple-900/20 transition-transform duration-300 hover:rotate-0">
      ...
      <div className="group relative">
        ...
        <div className="absolute inset-0 scale-[0.99] transform rounded-3xl bg-linear-to-r from-purple-100/50 to-pink-100/50 dark:from-purple-500/10 dark:to-pink-500/10 blur-2xl transition-all duration-500 group-hover:scale-100"></div>
        
        <div className="relative rounded-3xl border border-slate-200 bg-white/50 p-8 shadow-xs backdrop-blur-xl dark:border-white/10 dark:bg-slate-900/40 dark:shadow-2xl">
          <AlumniCard />
        </div>
      </div>
    </section>
