...
export const TimetableView = ({
    ...
    const isBreakTime = (lectureNumber: number) => {
        return lectureNumber === 8 // After 7th lecture, before 8th
    }
                        ...
                        <ScrollArea className="h-[1100px]">
                            {
                                teachers.map((teacher, index) => (
                                    <div key={teacher.employeeId} className={cn(
                                        "p-2 border rounded-lg min-h-[100px] relative group my-2",
                    ...
                    <div className="col-span-10">
                                        ...
                                        {DAYS_OF_WEEK.map((day) => {
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    className={cn(
                                                        "p-2 border rounded-lg min-h-[100px] relative group",
                                                        entry ? "bg-card hover:bg-accent/50" : "bg-muted/20 hover:bg-muted/40",
                                                        selectedEntry === entry?.timetableId && "ring-2 ring-primary",
                                                    )}
                                                    onClick={() =>
                                                        entry && setSelectedEntry(selectedEntry === entry.timetableId ? null : entry.timetableId)
                                                    }
                                                >
                                                    {entry ? (
                                                        ...
                                                        editable && (
                                                            <div className="flex items-center justify-center h-full opacity-0 group-hover:opacity-100 transition-opacity">
                                                                ...
                                                                // onClick={() => onAdd?.(day, lectureNumber)}
                                                                >
                        ...
                        <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                            <div className="flex items-center gap-2 text-yellow-800">
                                ...
                                <span className="text-sm">25-minute break after 7th lecture, 5-minute breaks between other lectures</span>
                            </div>
                        </div>
