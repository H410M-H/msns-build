    ...
    <div className="relative min-h-dvh w-full overflow-hidden bg-white text-slate-900 transition-colors duration-500 dark:bg-[#02131b] dark:text-foreground">
      ...
      <main className="relative z-10 flex flex-col items-center justify-center px-4 pb-20 pt-10 text-center sm:px-6 lg:pt-20">
        ...
        >
          <Link
            href="/sign-in"
            className="group relative flex w-full items-center justify-center gap-3 overflow-hidden rounded-2xl bg-emerald-600 px-8 py-4 text-lg font-bold text-foreground shadow-xl shadow-emerald-500/30 transition-all hover:scale-[1.02] hover:bg-emerald-50 hover:shadow-2xl hover:shadow-emerald-500/40 sm:w-auto"
          >
