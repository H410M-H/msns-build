  ...
  return (
    <section className="relative min-h-screen w-full bg-slate-950 overflow-x-hidden selection:bg-emerald-500/30">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        {/* Ambient Glows */}
        <div className="absolute top-0 right-0 w-125 h-125 bg-emerald-500/10 rounded-full blur-[100px] opacity-30" />
        <div className="absolute bottom-0 left-0 w-125 h-125 bg-teal-500/10 rounded-full blur-[100px] opacity-30" />
      </div>
