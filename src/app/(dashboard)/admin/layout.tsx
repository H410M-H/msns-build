    ...
    <SidebarProvider>
      ...
      <SidebarInset className="relative flex flex-col min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-200 overflow-x-hidden transition-colors duration-300 ease-in-out">
        ...
        <div className="fixed inset-0 z-0 h-full w-full pointer-events-none">
           ...
           {/* Dark Mode Pattern */}
           <div className="absolute inset-0 h-full w-full hidden dark:block bg-[radial-gradient(#1e293b_1px,transparent_1px)] [background-size:16px_16px] [mask-image:radial-gradient(ellipse_50%_50%_at_50%_50%,#000_70%,transparent_100%)]"></div>
        </div>
