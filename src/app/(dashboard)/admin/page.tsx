...
export default function DashboardPage() {
  ...
  return (
    // ⚡️ CHANGED: Removed 'max-w-7xl' and 'mx-auto' to allow full width
    <div className="w-full space-y-8">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
        ...
        >
          <Card className="flex-1 bg-gradient-to-br from-emerald-900/40 to-slate-900/40 border-emerald-500/20 backdrop-blur-md relative overflow-hidden shadow-xl">
            ...
            <CardContent className="grid grid-cols-2 gap-2">
              <Button size="sm" variant="secondary" className="bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-200 border border-emerald-500/20 transition-colors">
                <Plus className="mr-2 h-4 w-4" /> New User
              </Button>
              <Button size="sm" variant="secondary" className="bg-white/5 hover:bg-white/10 text-slate-200 border border-white/10 transition-colors">
