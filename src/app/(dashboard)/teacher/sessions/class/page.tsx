...
export default async function TeacherClassDetailsPage({ searchParams }: PageProps) {
  const searchProps = await searchParams;

  const breadcrumbs = [
    { href: "/teacher", label: "Dashboard" },
    {
      href: `/teacher/sessions/class?sessionId=${searchProps.sessionId}&classId=${searchProps.classId}`,
      label: "Class Details",
    },
  ];
