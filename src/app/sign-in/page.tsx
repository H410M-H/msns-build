...
export default function SignInPage() {
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-linear-to-br from-blue-50 via-white to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-indigo-950">
      {/* Background Section */}
      <div className="relative flex min-h-screen w-full flex-col items-center justify-center bg-[url('https://res.cloudinary.com/dvvbxrs55/image/upload/v1729267627/FrontView1_alaabu.jpg')] bg-cover bg-center bg-no-repeat px-6 py-16 sm:px-8 md:px-10 lg:px-12 xl:px-16">
        <div className="relative w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl">
          ...
          <div className="absolute inset-0 -skew-y-6 transform bg-linear-to-r from-emerald-400 to-emerald-800 opacity-80 shadow-xl transition-all duration-700 ease-in-out hover:rotate-0 hover:skew-y-0 hover:scale-105 sm:-rotate-6 sm:rounded-3xl" />
      ...
      {/* Footer */}
      <footer className="absolute bottom-0 left-0 w-full bg-white/40 py-4 text-center backdrop-blur-xs dark:bg-slate-900/40">
